...
const WARM_UP_EXIT_CHECK =
  "Each student rewrites 5(y + 2) and states what the second product represents.";
...
export const INTERVENTION_DRAFTS: InterventionDraft[] = [
  {
    ...
    originalRecommendation: {
      ...
      durationMinutes: 12,
      rationale:
        "Four learners repeat the same error class on the most recent checkpoint: the factor is applied to the first term only. Equality is preserved elsewhere, so a short targeted block is proposed rather than a re-teach of the cluster.",
      confidence: 0.62,
      limitations:
        "Demo AI metadata — seeded, not generated by a live model. Confidence is teacher-facing and is not a measurement of student ability.",
    },
  },
];

/** Standards shown in the class pattern grid and the gradebook matrix. */
export const STANDARD_COLUMNS = ["5.OA.A.1", "6.EE.A.2", "6.EE.A.3", "6.EE.B.7"];
